        ...
        <div class="mb-4 container-fluid">
            <div class="card">
                <div class="card-header">
                    <div class="col-md-3 d-flex justify-content-betweend align-items-center">
                        <h5>Pago de Materia Prima</h5> 
                    </div>
                            ...
                            <div class="modal-content mods">
                                ...
                                <div class="modal-body body-modal">
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <button class="btn  btn-warning" @click="mandarRevision()">Revisar Materia</button>
                                        </div>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button class="btn  btn-success" data-toggle="modal" :data-target="arrayDetalle.length > 0 ? '#persona': ''" @click="pasarCompra()">Pagar</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            comprarMateria(){ 
                var aux = parseFloat((this.totalModal).replace(/,/gi, ''));
                if(this.montoPagado <= aux){
                    ...
                    swalWithBootstrapButtons.fire({
                        title: '¿Pagar : ' + this.convert(this.montoPagado) + ' ?',
                        type: 'warning',
                        ...
                        if (result.value) {
                            let me = this;
                            axios.post("/Compra/store", {
                                'idRecepcion' : this.idRecepcion,
                                'id' : this.idProveedor,
                                'nombre': 'Compra Materia Prima',
                                'descripcion' : 'Compra de Materia prima Guía: '+ this.guia,
                                'montoTotal' : aux,
                                'cantidad' : this.montoPagado,
                                'guia' : this.guia,
                            ...
                            swalWithBootstrapButtons.fire(
                            'Se Adquirió nueva Materia Prima',
                            'La guía fue puesta en Adquisición.',
                            'success')
            ...
            mostrarRecepcion(page, buscar){
                let me = this;
                var url = '/Recepcion/pago?page='+page+'&buscar='+buscar
                axios.get(url).then((response)=>{
                    var respuesta = response.data;
