                                            ...
                                            <div class="row">
                                                <div class="col-md-12 d-flex">
                                                    ...
                                                    <div class="btn-group ml-auto " role="group">
                                                        <button type="button" class="btn btns btn-info btn-sm" @click="imprimir(encargo)">
                ...
                <template v-else>
                    <div class="card-header" style="background-color:#fff!important;">
                        <div class="row justify-content-center mt-1 mb-3">
                            <h4 style="text-decoration:underline; font-weight: bold;">Control de los encargos</h4>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-3 col-sm-6">
                                <a href="#" class="btn btn-primary btn-xs aux" @click="interior()" style="margin-bottom:4px; word-wrap:break-word;">ACTIVIDADES DESARROLLADAS AL INTERIOR DEL PAÍS</a>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <a href="#" class="btn btn-primary btn-xs aux" @click="exterior()" style="margin-bottom:4px; word-wrap:break-word;">ACTIVIDADES DESARROLLADAS AL EXTERIOR DEL PAÍS</a>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <input type="number" step="0.01" min="0" value="0" max="99999999.99" pattern="^\d*(\.\d{0,2})?$" v-model="monto_encargo" class="form-control">
