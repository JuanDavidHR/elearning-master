                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-4 btn1">
                                <h6 class="mt-1">Garantías por adelanto de materiales</h6>
                            </div>
                            <div class="col-md-4 btn1">
                ...
                <template v-else>
                    <div class="card-header" style="background-color:#fff!important;">
                        <div class="row justify-content-center mt-1 mb-3">
                            <h4 v-if="!garantia" style="font-weight: bold;">Control de las Garantías Por Adelanto de Materiales e Insumos</h4>
                        </div>
                        <div class="row mb-2">
