                                    ...
                                    <tr v-for="detalle in arrayDetalle" :key="detalle.idDetalleRecepcion">
                                        <td>
                                            <div class="btn-group" role="group">
                                                <button type="button" @click="llenarDatosDetalle(detalle.idDetalleRecepcion)" data-toggle="modal" data-target="#detalle" class="btn btn-info btn-sm" >
                        ...
                        <div class="modal-dialog modal-sm" role="document">
                            <div class="modal-content mods">
                                <div class="modal-header header-modal">
                                    <h4 class="mb-0">Descripción Cacao</h4>
