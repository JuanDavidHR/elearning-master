                ...
                <template v-else>
                    <div class="card-header" style="background-color:#fff!important;">
                        <div class="row justify-content-center mt-1 mb-3">
                            <h4 v-if="!garantia" style="font-weight: bold; text-transform: uppercase;">Control de las Garantías Por Adelanto Directo</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label for="" class="col-form-label">Adelanto directo:</label>
                                                        </div>
                                                        <div class="col-md-6">
