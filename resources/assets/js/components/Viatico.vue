                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-2 d-flex btn1">
                                <button class="btn ml-auto nuevo btn-success" @click="nuevoEncargo();">Nuevo viático</button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 d-flex">
                                                    ...
                                                    <div class="btn-group ml-auto " role="group">
                                                        <button type="button" class="btn btns mr-2 btn-warning btn-sm" @click="llenarFormulario(viatico)">
                                                            <i class="icon-pencil"></i>
                                                        </button>
                                                        <button type="button" class="btn btns mr-2 btn-info btn-sm" @click="imprimir(viatico)">
                                                            <i class="fa fa-print"></i>
                                                        </button>
                                                        <template v-if="viatico.vigencia">
                                                            <button type="button" class="btn btns btn-success btn-sm" @click="desactivarCategoria(viatico.idViatico)">
                                                                <i class="icon-check"></i>
                                                            </button>
                                                        </template>
                                                        <template v-else>
                                                            <button type="button" class="btn btns btn-danger btn-sm" @click="activarCategoria(viatico.idViatico)">
                ...
                <template v-else>
                    <div class="card-header" style="background-color:#fff!important;">
                        <div class="row justify-content-center mt-1 mb-3">
                            <h4 style="text-decoration:underline; font-weight: bold; text-transform: uppercase;">Control de los Viáticos</h4>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-3 col-sm-6">
                                <a href="#" class="btn btn-primary btn-xs aux" @click="interior()" style="margin-bottom:4px; word-wrap:break-word;" v-bind:class="{'borde' : bord == true}" >COMISIÓN DE SERVICIOS AL INTERIOR DEL PAÍS</a>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <a href="#" class="btn btn-primary btn-xs aux" @click="exterior()" style="margin-bottom:4px; word-wrap:break-word;" v-bind:class="{'borde': !bord == true}">COMISIÓN DE SERVICIOS AL EXTERIOR DEL PAÍS</a>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <vue-numeric v-bind:minus ="false" v-bind:precision="2" v-bind:min = "0" v-bind:max = "99999999.99" class="form-control"  currency="" separator="," v-model="monto_viatico"></vue-numeric>
                        ...
                        <div class="modal-footer mb-0">
                            ...
                            <button v-if="tipoAccion == 1" class="btn nuevo btn-success" @click="registrarEncargo();">Registrar viático</button>
                            <button v-if="tipoAccion == 2" class="btn nuevo btn-success" @click="actualizarEncargo();">Actualizar viático</button>
                        </div>
                    </div>
                </template>
            </div>
    ...
    export default {
        ...
        methods: {
            oportunidad(nombre_responsable){
                ...
                if(number.length >= 6){
                    axios.post("/Viatico/buscarPersona", {
                        ...
                        if(response.data.cantidad != 0){
                            ...
                            toastr["warning"]('La persona posee viáticos pendientes por rendir.', "Advertencia")
                            toastr.options = {
                                "closeButton": true,
                                "debug": false,
                                "newestOnTop": false,
