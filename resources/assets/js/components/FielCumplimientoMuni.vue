                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 btn1">
                                <div class="input-group">
                                    ...
                                    <button type="submit" @click.prevent="listarEgreso(1, buscar, mes, anho)" class="btn btn-primary muni btn-border"><i class="fa fa-search"></i> Buscar</button>
                                </div>
                            </div>    
                            <div class="col-md-4 btn1">
                        ...
                        <div class="row">
                            <template v-if="arrayViatico.length">
                                <div class="col-md-6 mb-2" v-for="fiel in arrayViatico" :key="fiel.idFiel">
                                    <div class="card" v-bind:class="{'help' : calcul(fiel.fecha_termino_garantia) >= 0,'subrayado': calcul(fiel.fecha_termino_garantia) < 0}">
                ...
                <template v-else>
                    <div class="card-header" style="background-color:#fff!important;">
                        <div class="row justify-content-center mt-1 mb-3">
                            <h4 v-if="!garantia" style="font-weight: bold;">Control de las Garantías de Fiel Cumplimiento</h4>
                        ...
                        <template v-if="!garantia">
                            ...
                            <div class="form-group">
                                <div class="row d-flex">
                                    ...
                                    <div class="col-md-3">
                                        <input type="number" step="0.01" min="0" value="0" max="99999999.99" pattern="^\d*(\.\d{0,2})?$" v-model="monto_garantia" class="form-control">
