                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-3 btn1">
                                <h6 class="mt-1" style="letter-spacing: -1px;">Garantías por adelanto de materiales</h6>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <template v-if="arrayViatico.length">
                                <div class="col-md-6 mb-2" v-for="directo in arrayViatico" :key="directo.idMateriales">
                                    <div class="card" v-bind:class="{'subrayado' : calcul(directo.fecha_reporte) >= 0,'help': calcul(directo.fecha_reporte) < 0}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 d-flex">
                                                    ...
                                                    <div class="btn-group ml-auto " role="group">
                                                        <button type="button" class="btn btns mr-2 btn-warning btn-sm" @click="llenarFormulario(directo)">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <!-- <span class="estilo">Plazo de Cobertura:</span> {{usemoment(directo.fecha_reporte)}} -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <template v-else>
                    <div class="card-header" style="background-color:#fff!important;">
                        <div class="row justify-content-center mt-1 mb-3">
                            <h4 v-if="!garantia" style="font-weight: bold; text-transform: uppercase;">Control de las Garantías Por Adelanto de Materiales e Insumos</h4>
                        </div>
                        <div class="row mb-2">
                    ...
                    <div class="card-body">
                        <template v-if="!garantia">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-2">
                                        <label for="" class="col-form-label">Obra:</label>
                                    </div>
                                    <div class="col-md-10">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label for="" class="col-form-label">Adelanto de materiales:</label>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <vue-numeric v-bind:minus ="false" v-bind:precision="2" v-bind:min = "0" v-bind:max = "99999999.99" class="form-control"  currency="" separator="," v-model="monto_adelanto_1"></vue-numeric>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card-body border" style="background:#b2ebf2;">
                                        <p class="mb-0">La garantía por adelanto de materiales debe tener una vigencia mínima de 3 meses, en caso que el plazo de ejecución contractual sea menor, podrá ser ajustada. Tratándose de  adelantos de materiales para la ejecución de obras, estos no pueden exceder el 20% del monto del contrato original y para su solicitud se considerará el calendario de adquisición de materiales presentado por el contratista.</p>
                                        <p><span style="font-weight:bold !important;font-style:italic !important;">(Arts. 153° , 180°, 182° del Reglamento de la Ley N° 30225, Ley de Contrataciones del Estado aprobada mediante  D.S. N° 344-2018-EF vigente desde el 30 de enero de 2019 y modificada mediante Decreto Supremo N° 377-2019-EF de 14 de diciembre de 2019).</span>
                                        </p>
                                    </div>
                                </div>
    ...
    export default {
        ...
        methods: {
            ...
            llenarFormulario(data){
                this.garantia = false;
                this.tipoAccion = 2;
                this.idMateriales = data['idMateriales'];
            ...
            modificarGarantia(){
                ...
                if(this.permite_1 == true && this.permite_2 == false && this.permite_3 == false){
                    ...
                    if(pass && this.fecha_desde_adelanto_2 == '' && this.fecha_hasta_adelanto_2 == ''){
                        url = "/Materiales/actualizarGarantia";
                        monto1 = this.monto_adelanto_1;
                        monto2 = "0.0";
                        monto3 = "0.0";
                        monto4 = "0.0";
                    }else{
                        url = "/Materiales/actualizarGarantia1";
                        monto1 = this.monto_adelanto_1;
                ...
                if(this.permite_1 == true && this.permite_2 == true && this.permite_3 == false){
                    ...
                    if(pass && this.fecha_desde_adelanto_3 == '' && this.fecha_hasta_adelanto_3 == ''){
                        ...
                        url = "/Materiales/actualizarGarantia2";
                        monto1 = this.monto_adelanto_1;
                        monto2 = this.monto_adelanto_2;
                ...
                if(this.permite_1 == true && this.permite_2 == true && this.permite_3 == true){
                    ...
                    if(pass && this.fecha_desde_adelanto_4 == '' && this.fecha_hasta_adelanto_4 == ''){
                        ...
                        url = "/Materiales/actualizarGarantia3";
                        monto1 = this.monto_adelanto_1;
                        monto2 = this.monto_adelanto_2;
                        monto3 = this.monto_adelanto_3;
                ...
                let me = this;
                axios.post(url, {
                    'idMateriales' : this.idMateriales,
            ...
            imprimir(data){
                ...
                //window.open('http://127.0.0.1:8000/Materiales/printf/'+'RGDUQc7pPdWVPKGekpIHMOKG7fwFcO8H+JMs92yylpAypUPtIOznlxtfIayb9811D5EQ43fCvInBjV5yPU9g=='+'/'+data['idMateriales']+'/'+monto_sum+'/RGDUQc7pPdWVPKGekpIHMOKG7fwFcO8H+JMs92yylpAypUPtIOznlxtfIayb9811D5EQ43fCvInBjV5yPU9g=='+ '/' + titulo);
                window.open('http://muni.pibea.org/Materiales/printf/'+'RGDUQc7pPdWVPKGekpIHMOKG7fwFcO8H+JMs92yylpAypUPtIOznlxtfIayb9811D5EQ43fCvInBjV5yPU9g=='+'/'+data['idMateriales']+'/'+monto_sum+'/RGDUQc7pPdWVPKGekpIHMOKG7fwFcO8H+JMs92yylpAypUPtIOznlxtfIayb9811D5EQ43fCvInBjV5yPU9g=='+ '/' + titulo);
            },
            nuevoEncargo(){
                this.garantia = false;
                this.tipoAccion = 1;
            ...
            registrarEncargo(){
                this.errors = [];
                let me = this;
                axios.post("/Materiales/registrar", {
                    'fecha_remision' : me.savemoment(this.fecha_remision),
                    'fecha_recepcion' : me.savemoment(this.fecha_recepcion),
                    'documento_remision' : this.documento_remision,
                    'contrato' : this.contrato,
            ...
            listarEgreso(page, buscar, mes, anho){
                let me = this;
                var url = '/Materiales?page=' + page + '&buscar=' + buscar + '&mes=' + mes + '&anho=' + anho ;
